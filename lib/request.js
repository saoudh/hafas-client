...
var proxies =
	[
		// "http://localhost:4000/proxy_request",
		"http://138.201.157.184:4000/proxy_request",
		"http://159.69.120.3:4000/proxy_request",
		// "http://138.201.157.184:4000/proxy_request",
		"http://78.46.93.86:4000/proxy_request",
		"http://85.215.82.15:4000/proxy_request",
		"http://85.214.23.152:4000/proxy_request",
		// "http://85.214.111.187:4000/proxy_request",
		"http://85.214.32.128:4000/proxy_request",
		"http://78.47.145.162:4000/proxy_request"
...
const request = (ctx, userAgent, reqData) => {
	...
	url = currentProxyIP + '/' + stringify(req.query) + `?target=${encodeURIComponent(profile.endpoint)}`
	// }
